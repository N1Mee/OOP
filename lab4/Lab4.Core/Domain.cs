...
namespace Lab4.Core
{
    ...
    public class MediaItemList
    {
        ...
        /// <summary>Serializes current collection to a BSON file.</summary>
        public void SaveToBson(string filePath)
        {
            ...
            File.WriteAllBytes(filePath, document.ToBson());
        }

        /// <summary>Loads collection from a BSON file, replacing current items.</summary>
